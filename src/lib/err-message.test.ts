// Fleet master test of the error-text helper (Entwicklung/CLAUDE_CODING.md) — run
// against this adapter's `errMessage`, unchanged apart from the import.
import http from "node:http";
import net from "node:net";
import { errMessage as errText } from "./err-message";
